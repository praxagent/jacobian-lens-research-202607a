...
Attack construct validity first: is cross-layer state substitution the right estimand for 'depth blocks partition computation', or is this a carefully-measured null of the wrong thing? Then judge whether the negative result is publishable or merely underpowered.
